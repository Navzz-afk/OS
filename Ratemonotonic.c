...
// Function to sort tasks by their periods (Rate Monotonic)
...
// Function to find the highest priority task (shortest period) that is ready to execute
...
// Function to simulate the execution of tasks in the system
...
int main() {
    ...
    // Sort tasks based on their periods (Rate Monotonic)
